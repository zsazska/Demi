scoreboard players operation $xrot rotation_calc = @s right_rotation_x
scoreboard players operation $yrot rotation_calc = @s right_rotation_y
scoreboard players operation $zrot rotation_calc = @s right_rotation_z
...
data modify entity @s transformation.right_rotation set from storage derot Out
