...
execute as @e[tag=modify,limit=1] if data entity @s brightness store result score @s demi_previousvalue run data get entity @s brightness.sky 1
execute as @e[tag=modify,limit=1] if data entity @s brightness if score @s demi_previousvalue matches ..14 run scoreboard players add @s demi_previousvalue 1
execute as @e[tag=modify,limit=1] if data entity @s brightness store result entity @s brightness.sky int 1 run scoreboard players get @s demi_previousvalue
